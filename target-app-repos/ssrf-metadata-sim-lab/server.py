...
APP_ID = 'ssrf-metadata-sim-lab'
APP_NAME = 'SSRF Metadata Simulation Lab'
COVERAGE = 'Safe SSRF and cloud-metadata simulation endpoints without real cloud metadata exposure or callbacks.'
ENDPOINTS = [('/', 'SSRF metadata simulator'), ('/fetch', 'Fetch shape'), ('/metadata/latest/meta-data/', 'Metadata root'), ('/metadata/latest/user-data', 'Metadata user-data shape'), ('/internal/admin', 'Internal admin shape')]
