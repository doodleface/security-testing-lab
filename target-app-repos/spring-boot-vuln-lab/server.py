...
APP_ID = 'spring-boot-vuln-lab'
APP_NAME = 'Spring Boot Vulnerable Lab'
COVERAGE = 'Spring Boot actuator, MVC, JSON error, and Java route coverage beyond WebGoat, Petclinic, and BenchmarkJava.'
ENDPOINTS = [('/', 'Spring Boot lab index'), ('/actuator', 'Actuator index'), ('/actuator/env', 'Actuator env shape'), ('/api/users/1', 'User API'), ('/error', 'Error route')]
