...
function initializeGlobals()
	...
	Call debugInfo("config.initGlobals:  initialization completed in " & timer - start & " seconds.")
end function
...
function initDomainGlobals()
	Call trace("config.initDomainGlobals...")
...
function initDatabaseGlobals()
	Call trace("config.initDatabaseGlobals...")
	...
	Call debugInfo("SITE_PATH: " & globals("SITE_PATH"))
	Call debugInfo("DB_SOURCE: " & globals("DB_SOURCE"))
...
function initSiteGlobals()
	Call trace("config.initSiteGlobals...")
