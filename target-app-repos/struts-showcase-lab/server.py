...
APP_ID = 'struts-showcase-lab'
APP_NAME = 'Apache Struts Showcase Lab'
COVERAGE = 'Struts-style actions, OGNL-shaped parameters, upload, and Java MVC routing under strict lab isolation.'
ENDPOINTS = [('/', 'Struts lab index'), ('/struts2-showcase/index.action', 'Showcase action'), ('/struts2-showcase/upload.action', 'Upload action'), ('/struts2-showcase/debug.action', 'Debug action'), ('/struts2-showcase/json.action', 'JSON action')]
