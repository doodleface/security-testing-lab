...
APP_ID = 'cache-deception-variants-lab'
APP_NAME = 'Web Cache Deception Variants Lab'
COVERAGE = 'Additional deterministic cache deception path, suffix, content-type, and private-page variants for cache scanners.'
ENDPOINTS = [('/', 'Cache deception variants'), ('/account/profile.css', 'Private suffix variant'), ('/private/invoice.jpg', 'Private file-like variant'), ('/api/me.js', 'API script-like variant'), ('/static/cacheable.css', 'Static control')]
