...
function getContent()
	...
	Call debug("mod_rss.display: starting mod_rss module....")
	if settings.exists("feed_url") then
		feed_url = settings("feed_url")
		Call debug("mod_rss.display: feed_url to display: " & codeblock(Server.HtmlEncode(feed_url)) )
		dim rss
		...
		Call debug("mod_rss.display: no feed_url found in this snippet.")
	end if
end function
