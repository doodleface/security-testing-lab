...
APP_ID = 'grpc-web-demo-lab'
APP_NAME = 'gRPC-Web Demo Lab'
COVERAGE = 'Non-REST API protocol, grpc-web content types, reflection-like metadata, and unary route coverage'
ROUTES = {'/': 'overview landing page', '/login': 'role boundary form shape', '/admin': 'admin workflow route', '/api/v1/status': 'JSON API metadata endpoint', '/upload': 'upload workflow route', '/search': 'search/query route', '/health': 'health metadata endpoint', '/grpc.health.v1.Health/Check': 'grpc-web health', '/demo.Inventory/GetItem': 'unary method', '/reflection/services': 'service metadata'}
