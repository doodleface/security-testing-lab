...
APP_ID = 'typo3-prestashop-legacy-lab'
APP_NAME = 'TYPO3 PrestaShop Legacy Lab'
COVERAGE = 'Legacy CMS/e-commerce route, admin, module, asset, and install-surface coverage beyond Drupal, Joomla, Magento, and WordPress.'
ENDPOINTS = [('/', 'Legacy CMS index'), ('/typo3/', 'TYPO3 admin shape'), ('/prestashop/admin-dev/', 'PrestaShop admin shape'), ('/modules/payments/callback', 'Module callback'), ('/install/', 'Install shape')]
