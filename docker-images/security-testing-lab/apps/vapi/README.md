...
Docker asset: docker-images/security-testing-lab/bundles/ct-target-holdout/additional-api-targets.yml
Compose reference: bundles/ct-target-holdout/additional-api-targets.yml
