...
APP_ID = 'grafana-dashboard-lab'
APP_NAME = 'Grafana Dashboard Lab'
COVERAGE = 'Dashboard, data-source proxy, saved query, and plugin-style route coverage'
ROUTES = {'/': 'overview landing page', '/login': 'role boundary form shape', '/admin': 'admin workflow route', '/api/v1/status': 'JSON API metadata endpoint', '/upload': 'upload workflow route', '/search': 'search/query route', '/health': 'health metadata endpoint', '/d/demo/dashboard': 'dashboard', '/api/datasources/proxy/1/query': 'data-source proxy', '/api/search': 'saved object search'}
