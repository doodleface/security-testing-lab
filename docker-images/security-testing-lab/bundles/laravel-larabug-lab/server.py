...
APP_ID = 'laravel-larabug-lab'
APP_NAME = 'Laravel LaraBug Lab'
COVERAGE = 'Laravel-style PHP framework routing, blade template, debug, storage, and CSRF form surfaces distinct from CMS/classic PHP apps.'
ENDPOINTS = [('/', 'Laravel lab index'), ('/debug/ignition', 'Debug route'), ('/storage/logs/app.log', 'Storage route'), ('/form/profile', 'CSRF form shape'), ('/api/user/1', 'API user shape')]
