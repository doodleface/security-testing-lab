...
const UNKNOWN_REFERER = "UNKNOWN"
	...
	if blnSearchReferral = true then
		...
		Call debugInfo("Insite Referral is " & blnInsiteReferral)
	...
	Call debugInfo("referer was " & strReferer)
	Call debugInfo("site url is: " & globals("SITEURL"))
	Call debugInfo("requested url is: " & strURL)
