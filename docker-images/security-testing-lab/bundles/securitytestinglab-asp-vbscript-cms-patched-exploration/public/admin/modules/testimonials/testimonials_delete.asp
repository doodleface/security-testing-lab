...
function contentDelete()
	...
	id = cint(id)
	Call debugInfo("admin." & strContent & ".delete: form was submitted, storing to the session.")
	strError = "An error was encountered during " & strContent & " deletion"
	Call debug("admin." & strContent & ".delete: delete database content for " & strContent & " id '" & id & "'")
