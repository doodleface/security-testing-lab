...
APP_ID = 'ghost-express-cms-lab'
APP_NAME = 'Ghost Express CMS Lab'
COVERAGE = 'Node/Express CMS-style content, admin, asset, redirect, and API route coverage distinct from NodeGoat and DVNA.'
ENDPOINTS = [('/', 'Express CMS index'), ('/ghost/api/content/posts', 'Content API'), ('/ghost/admin/', 'Admin route'), ('/assets/theme.js', 'Theme asset'), ('/redirect', 'Redirect shape')]
