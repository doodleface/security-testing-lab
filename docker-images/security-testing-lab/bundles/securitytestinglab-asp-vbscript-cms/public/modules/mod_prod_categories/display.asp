...
function getCategories()
  ...
  pid = Request.QueryString("catid")
		Call trace("mod_prod_categories: selecting active categories...")
		...
		Call trace("mod_prod_categories: ...done selecting active categories")
		Call trace("mod_prod_categories: printing categories list to page...")
		...
		Call trace("mod_prod_categories: ...end printing categories list, " & numCategories & " categories listed.")
		numCategories = null
