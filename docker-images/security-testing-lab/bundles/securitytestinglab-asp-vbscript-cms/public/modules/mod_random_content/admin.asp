...
Call debug("mod_random_content.fields: the parent page id is: " & parent_page_id)
Call debug("mod_random_content.fields: the pre content is: " & content_pre)
Call debug("mod_random_content.fields: the post content is: " & content_post)
