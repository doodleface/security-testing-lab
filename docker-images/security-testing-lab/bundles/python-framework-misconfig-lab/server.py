...
APP_ID = 'python-framework-misconfig-lab'
APP_NAME = 'Python Framework Misconfiguration Lab'
COVERAGE = 'Flask/Django-style route, template, upload, debug-header, and auth/session misconfiguration surfaces beyond Django.nV and Vulpy.'
ENDPOINTS = [('/', 'Python framework lab'), ('/flask/debug', 'Debug route'), ('/django/template', 'Template route'), ('/upload', 'Upload shape'), ('/session/profile', 'Session profile')]
