...
APP_ID = 'keycloak-oidc-weak-client'
APP_NAME = 'Keycloak Weak OIDC Client Lab'
COVERAGE = 'OIDC/Keycloak-like weak client and discovery metadata for OAuth, OIDC, JWT, redirect, and session adapter exercise.'
ENDPOINTS = [('/', 'OIDC lab index'), ('/.well-known/openid-configuration', 'OIDC discovery'), ('/realms/securitytestinglab/protocol/openid-connect/auth', 'Auth endpoint'), ('/weak-client/callback', 'Weak client callback'), ('/jwks', 'JWKS metadata')]
