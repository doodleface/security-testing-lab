...
APP_ID = 'roundcube-webmail-lab'
APP_NAME = 'Roundcube Webmail Lab'
COVERAGE = 'Webmail, MIME preview, address-book, attachment, and mail-auth flow coverage'
ROUTES = {'/': 'overview landing page', '/login': 'role boundary form shape', '/admin': 'admin workflow route', '/api/v1/status': 'JSON API metadata endpoint', '/upload': 'upload workflow route', '/search': 'search/query route', '/health': 'health metadata endpoint', '/mail/inbox': 'mailbox list', '/mail/preview': 'MIME preview', '/addressbook': 'address book'}
