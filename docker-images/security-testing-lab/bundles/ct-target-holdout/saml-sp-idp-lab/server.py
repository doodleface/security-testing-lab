...
APP_ID = 'saml-sp-idp-lab'
APP_NAME = 'SAML SP IdP Lab'
COVERAGE = 'SAML SP/IdP metadata and ACS/SLO shapes for saml_raider and XML security adapter exercise without retaining assertions.'
ENDPOINTS = [('/', 'SAML lab index'), ('/sp/metadata', 'SP metadata'), ('/idp/metadata', 'IdP metadata'), ('/saml/acs', 'ACS endpoint'), ('/saml/slo', 'SLO endpoint')]
