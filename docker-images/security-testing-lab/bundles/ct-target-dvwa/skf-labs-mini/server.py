...
APP_ID = 'skf-labs-mini'
APP_NAME = 'OWASP SKF Labs Mini'
COVERAGE = 'SKF-style focused labs for SSRF, IDOR, XXE, JWT, path traversal, and deserialization route shapes.'
ENDPOINTS = [('/', 'SKF mini index'), ('/labs/ssrf', 'SSRF shape'), ('/labs/idor/1001', 'IDOR shape'), ('/labs/xxe', 'XXE shape'), ('/labs/path-traversal', 'Path traversal shape'), ('/labs/deserialization', 'Deserialization shape')]
