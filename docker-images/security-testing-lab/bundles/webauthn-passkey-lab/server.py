...
APP_ID = 'webauthn-passkey-lab'
APP_NAME = 'WebAuthn Passkey Lab'
COVERAGE = 'Modern browser authentication ceremony, attestation, assertion, and downgrade/misconfiguration coverage'
ROUTES = {'/': 'overview landing page', '/login': 'role boundary form shape', '/admin': 'admin workflow route', '/api/v1/status': 'JSON API metadata endpoint', '/upload': 'upload workflow route', '/search': 'search/query route', '/health': 'health metadata endpoint', '/register/begin': 'registration begin', '/register/finish': 'registration finish', '/assertion/options': 'assertion options'}
