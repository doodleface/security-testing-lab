...
APP_ID = 'ssti-matrix-lab'
APP_NAME = 'SSTI Matrix Lab'
COVERAGE = 'Jinja2, Twig, Freemarker, and Velocity template-engine comparison coverage'
ROUTES = {'/': 'overview landing page', '/login': 'role boundary form shape', '/admin': 'admin workflow route', '/api/v1/status': 'JSON API metadata endpoint', '/upload': 'upload workflow route', '/search': 'search/query route', '/health': 'health metadata endpoint', '/jinja2/render': 'Jinja2 render', '/twig/render': 'Twig render', '/freemarker/render': 'Freemarker render', '/velocity/render': 'Velocity render'}
