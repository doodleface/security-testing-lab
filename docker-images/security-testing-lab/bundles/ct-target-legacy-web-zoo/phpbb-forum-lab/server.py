...
APP_ID = 'phpbb-forum-lab'
APP_NAME = 'phpBB Forum Lab'
COVERAGE = 'Forum workflows, BBCode rendering, moderation, plugin, and session coverage'
ROUTES = {'/': 'overview landing page', '/login': 'role boundary form shape', '/admin': 'admin workflow route', '/api/v1/status': 'JSON API metadata endpoint', '/upload': 'upload workflow route', '/search': 'search/query route', '/health': 'health metadata endpoint', '/viewtopic.php': 'topic rendering', '/posting.php': 'BBCode posting', '/mcp.php': 'moderation control panel'}
