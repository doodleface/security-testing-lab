...
APP_ID = 'graphql-voyager-demo'
APP_NAME = 'GraphQL Voyager Demo API'
COVERAGE = 'Additional GraphQL schema and voyager-style introspection endpoint for GraphQL adapter diversity beyond DVGA.'
ENDPOINTS = [('/', 'GraphQL voyager demo'), ('/graphql', 'GraphQL endpoint'), ('/voyager', 'Voyager UI placeholder'), ('/schema', 'Schema metadata')]
