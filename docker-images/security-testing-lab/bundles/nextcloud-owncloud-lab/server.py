...
APP_ID = 'nextcloud-owncloud-lab'
APP_NAME = 'Nextcloud ownCloud Lab'
COVERAGE = 'File sharing, WebDAV, public-link, sync API, and quota workflow coverage'
ROUTES = {'/': 'overview landing page', '/login': 'role boundary form shape', '/admin': 'admin workflow route', '/api/v1/status': 'JSON API metadata endpoint', '/upload': 'upload workflow route', '/search': 'search/query route', '/health': 'health metadata endpoint', '/remote.php/dav/files/demo': 'WebDAV file path', '/s/public-link': 'public share', '/ocs/v2.php/cloud/capabilities': 'OCS capabilities'}
