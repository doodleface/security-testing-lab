...
APP_ID = 'kibana-opensearch-lab'
APP_NAME = 'Kibana OpenSearch Dashboards Lab'
COVERAGE = 'Saved objects, dashboard APIs, index-pattern, and proxy-style data access coverage'
ROUTES = {'/': 'overview landing page', '/login': 'role boundary form shape', '/admin': 'admin workflow route', '/api/v1/status': 'JSON API metadata endpoint', '/upload': 'upload workflow route', '/search': 'search/query route', '/health': 'health metadata endpoint', '/app/dashboards': 'dashboards', '/api/saved_objects/_find': 'saved objects', '/internal/search/es': 'proxy-style search'}
