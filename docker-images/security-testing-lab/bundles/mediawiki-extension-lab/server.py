...
APP_ID = 'mediawiki-extension-lab'
APP_NAME = 'MediaWiki Extension Lab'
COVERAGE = 'Wiki templates, page history, extension routes, and permission-boundary coverage'
ROUTES = {'/': 'overview landing page', '/login': 'role boundary form shape', '/admin': 'admin workflow route', '/api/v1/status': 'JSON API metadata endpoint', '/upload': 'upload workflow route', '/search': 'search/query route', '/health': 'health metadata endpoint', '/wiki/Main_Page': 'wiki page', '/w/index.php': 'template edit', '/api.php': 'wiki API'}
