...
APP_ID = 'portswigger-websec-subset'
APP_NAME = 'PortSwigger-style Web Security Academy Subset'
COVERAGE = 'Self-hosted WebGoat-like subset for request smuggling indicators, access control, cache poisoning, and parameter pollution surfaces.'
ENDPOINTS = [('/', 'academy subset index'), ('/lab/access-control', 'Access control'), ('/lab/parameter-pollution', 'Parameter pollution'), ('/lab/cache-poisoning', 'Cache poisoning'), ('/lab/request-routing', 'Request routing')]
