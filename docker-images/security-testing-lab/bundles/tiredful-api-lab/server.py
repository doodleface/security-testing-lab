...
APP_ID = 'tiredful-api-lab'
APP_NAME = 'Tiredful REST API Lab'
COVERAGE = 'REST/OpenAPI style API collection for Schemathesis, RESTler, OpenAPI parsing, auth-boundary, and error handling checks.'
ENDPOINTS = [('/', 'REST API index'), ('/openapi.json', 'OpenAPI metadata'), ('/api/v1/items', 'Items API'), ('/api/v1/orders/1001', 'Order API'), ('/api/v1/profile', 'Profile API')]
